...
#pragma region API declare prototypes
		...
		*/
		static RZRESULT CreateEffect(RZDEVICEID deviceId, ChromaSDK::EFFECT_TYPE effect, int* colors, int size, FChromaSDKGuid* effectId);
		/*
			Delete an effect given the effect id.
		*/
		static RZRESULT DeleteEffect(const FChromaSDKGuid& effectId);
		/*
		...
		*/
		static RZRESULT SetEffect(const FChromaSDKGuid& effectId);
		/*
